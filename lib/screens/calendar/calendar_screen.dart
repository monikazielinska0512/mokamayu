...
class _CalendarScreenState extends State<CalendarScreen> {
      ...
      getEvents.forEach((key, value) {
        ...
        for (var element in val) {
          ...
          Outfit outfit = Outfit(
              ...
              styles: List.from(mapOutfit['styles']),
  ...
  Map<String, Widget>? getTabs() => {
        S.of(context).calendar: buildCalendar(),
        S.of(context).planned_outfits: buildPlannedOutfits()
      };
                      ...
                      child: Center(
                          child: Column(
                            ...
                            Padding(
                                ...
                                child: Text(S.of(context).empty_planned_outfits,
                                    textAlign: TextAlign.center,
                                    style: TextStyles.paragraphRegular14(
                                        Colors.grey)))
                          ])))))
