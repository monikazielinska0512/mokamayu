...
class _OutfitsAddAttributesScreenState
  ...
  Widget build(BuildContext context) {
    ...
    widget.map = Provider
        .of<PhotoTapped>(context, listen: true)
        .getMapDynamic;
                            ...
                            screenshotController
                              ...
                              if (item == null) {
                                ...
                                imagePath = await File(
                                    '${directory.path}/image${const Uuid()
                                        .v4()}.png')
                                    .create();
                              } else {
                                final directory =
        ...
        child: Expanded(
            child: Column(children: [
              SizedBox(
                  child: Padding(
                      padding: const EdgeInsets.all(10),
                      child: OutfitForm(formKey: formKey, item: item))),
            ])));
  }
    ...
    return GestureDetector(
        onTap: () {
          ...
          Map<DateTime, List<Event>> events =
              Provider
                  .of<CalendarManager>(context, listen: false)
                  .getEvents;
